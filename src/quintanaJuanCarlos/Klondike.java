...
public class Klondike {
    ...
    private void seleccionarAccion(int opcion) {
        switch (opcion) {
            case 1 ->
                TAPETE.moverBarajaDescarte();
            case 2 ->
                TAPETE.moverDescartePalo();
            case 3 ->
                TAPETE.moverDescarteColumna();
            case 4 ->
                TAPETE.moverPaloColumna();
            case 5 ->
                TAPETE.moverColumnaPalo();
            case 6 ->
                TAPETE.moverColumnaColumna();
            case 7 ->
                TAPETE.voltearCartaColumna();
            case 8 ->
                TAPETE.voltearDescarteBaraja();
            case 9 ->
                salir();
            default ->
